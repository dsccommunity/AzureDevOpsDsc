<#
    ...
    .EXAMPLE
        New-DevOpsApiResource -ApiUri 'YourApiUriHere' -Pat 'YourPatHere' -ResourceName 'Project' -Resource $YourResource -Wait
    ...
    .EXAMPLE
        New-DevOpsApiResource -ApiUri 'YourApiUriHere' -Pat 'YourPatHere' -ResourceName 'Project' -Resource $YourResource
...
#>
function New-DevOpsApiResource
{

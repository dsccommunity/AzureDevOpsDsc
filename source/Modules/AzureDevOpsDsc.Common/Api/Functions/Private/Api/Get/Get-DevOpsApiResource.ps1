<#
    ...
    .EXAMPLE
        Get-DevOpsApiResource -ApiUri 'YourApiUriHere' -Pat 'YourPatHere' -ResourceName 'Project'

        Returns all 'Project' resources from the Azure DevOps API related to the Organization/ApiUri
        value provided.

    .EXAMPLE
        Get-DevOpsApiResource -ApiUri 'YourApiUriHere' -Pat 'YourPatHere' -ResourceName 'Project' -ResourceId 'YourProjectId'
...
#>
function Get-DevOpsApiResource
{
    [CmdletBinding()]
    ...
    # Prepare 'Get-DevOpsApiResourceUri' method parameters
    ...
    $invokeRestMethodParameters = @{
        Uri = $(Get-DevOpsApiResourceUri @apiResourceUriParameters)
        Method = 'Get'

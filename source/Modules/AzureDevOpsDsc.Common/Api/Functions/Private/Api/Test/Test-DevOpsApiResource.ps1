<#
    ...
    .EXAMPLE
        Test-DevOpsApiResource -ApiUri 'YourApiUriHere' -Pat 'YourPatHere' `
        ...
        if it does not.
#>
function Test-DevOpsApiResource
{
    [CmdletBinding()]
    ...
    (
        ...
        [Parameter(Mandatory = $true)]
        [ValidateScript({ Test-DevOpsApiResourceName -ResourceName $_ -IsValid })]
        [System.String]
        $ResourceName,

        [Parameter(Mandatory = $true)]
        [ValidateScript({ Test-DevOpsApiResourceId -ResourceId $_ -IsValid })]
        [Alias('Id')]
        [System.String]
        $ResourceId
    )

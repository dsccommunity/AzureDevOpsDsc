...
.DESCRIPTION
The Set-AzDevOpsGroup function is used to update an Azure DevOps group by sending a PATCH request to the Azure DevOps REST API.
...
.EXAMPLE
Set-AzDevOpsGroup -ApiUri "https://dev.azure.com/contoso" -GroupName "MyGroup" -GroupDescription "Updated group description"

function AzDoAPI_6_IdentitySubjectDescriptors
{
    ...
    ForEach ($AzDoLiveGroup in $AzDoLiveGroups) {
        ...
        $cacheParams = @{
            ...
            Value = $AzDoLiveGroup | Add-Member -MemberType NoteProperty -Name ACLIdentity -Value $ACLIdentity -PassThru
            Type = 'LiveGroups'
    ...
    ForEach ($AzDoLiveUser in $AzDoLiveUsers) {
        ...
        $cacheParams = @{
            ...
            Value = $AzDoLiveUser | Add-Member -MemberType NoteProperty -Name ACLIdentity -Value $ACLIdentity -PassThru
            Type = 'LiveGroups'
            SuppressWarning = $true
        }

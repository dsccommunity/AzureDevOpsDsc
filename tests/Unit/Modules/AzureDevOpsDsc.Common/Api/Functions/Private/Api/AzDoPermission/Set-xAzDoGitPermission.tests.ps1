powershell
Describe "Set-xAzDoGitPermission Unit Tests" {
    ...
    Context "When parameters are correctly passed" {
        It "Should call Invoke-AzDevOpsApiRestMethod with correct parameters" {
            Set-xAzDoGitPermission -OrganizationName $fakeOrgName -SecurityNamespaceID $fakeSecurityNamespaceID -SerializedACLs $fakeSerializedACLs -ApiVersion $fakeApiVersion
        ...
        It "Should default ApiVersion if not provided" {
            Set-xAzDoGitPermission -OrganizationName $fakeOrgName -SecurityNamespaceID $fakeSecurityNamespaceID -SerializedACLs $fakeSerializedACLs
    ...
    Context "When an error occurs" {
        It "Should write an error message" {
            ...
            { Set-xAzDoGitPermission -OrganizationName $fakeOrgName -SecurityNamespaceID $fakeSecurityNamespaceID -SerializedACLs $fakeSerializedACLs -ApiVersion $fakeApiVersion } | Should -Throw

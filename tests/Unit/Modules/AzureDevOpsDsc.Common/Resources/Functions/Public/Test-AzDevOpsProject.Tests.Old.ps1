...
InModuleScope $script:subModuleName {
    ...
    Describe 'AzureDevOpsDsc.Common\Test-AzDevOpsProject' -Tag 'GetAzDevOpsProject' {
        ...
        Context 'When called with valid parameters' {
            ...
            Context 'When called with no "ProjectId" parameter and no "ProjectName" parameter' {
                ...
                It 'Should throw - "<ApiUri>", "<Pat>"' -TestCases $testCasesValidApiUriPatCombined {
                    param ([string]$ApiUri, [string]$Pat)

                    { Test-AzDevOpsProject -ApiUri $ApiUri -Pat $Pat } | Should -Throw
                }
            ...
            Context 'When called with no "ProjectId" parameter but with a "ProjectName" parameter' {
                ...
                It 'Should return "bool" - "<ApiUri>", "<Pat>", "<ProjectName>"' -TestCases $testCasesValidApiUriPatProjectNameCombined {
                    param ([string]$ApiUri, [string]$Pat, [string]$ProjectName)

                    $result = Test-AzDevOpsProject -ApiUri $ApiUri -Pat $Pat -ProjectName $ProjectName
                ...
                Context 'When a "Project" with supplied "ProjectName" parameter value exists' {
                    ...
                    It 'Should call "Get-AzDevOpsApiResource" function atleast once - "<ApiUri>", "<Pat>", "<ProjectName>"' -TestCases $testCasesValidApiUriPatProjectNameCombined {
                        param ([string]$ApiUri, [string]$Pat, [string]$ProjectName)

                        Test-AzDevOpsProject -ApiUri $ApiUri -Pat $Pat -ProjectName $ProjectName | Out-Null
                        Should -Invoke Get-AzDevOpsApiResource -ModuleName $script:subModuleName -Times 1 -Scope It
                    }
                }
                ...
                Context 'When a "Project" with supplied "ProjectName" parameter value does not exist' {
                    ...
                    It 'Should return $false - "<ApiUri>", "<Pat>"' -TestCases $testCasesValidApiUriPatCombined {
                        ...
                        $result = Test-AzDevOpsProject -ApiUri $ApiUri -Pat $Pat -ProjectName 'NonPresentProjectName'
            ...
            Context 'When called with no "ProjectName" parameter but with a "ProjectId" parameter' {
                ...
                It 'Should return "bool" - "<ApiUri>", "<Pat>", "<ProjectId>"' -TestCases $testCasesValidApiUriPatProjectIdCombined {
                    param ([string]$ApiUri, [string]$Pat, [string]$ProjectId)

                    $result = Test-AzDevOpsProject -ApiUri $ApiUri -Pat $Pat -ProjectId $ProjectId
                    $result.GetType() | Should -BeIn $([System.Boolean]::new()).GetType()
                }

                It 'Should call "Get-AzDevOpsApiResource" function atleast once - "<ApiUri>", "<Pat>", "<ProjectId>"' -TestCases $testCasesValidApiUriPatProjectIdCombined {
                    param ([string]$ApiUri, [string]$Pat, [string]$ProjectId)
                ...
                Context 'When a "Project" with supplied "ProjectId" parameter value does not exist' {
                    ...
                    It 'Should return $false - "<ApiUri>", "<Pat>"' -TestCases $testCasesValidApiUriPatCombined {
                        ...
                        $result = Test-AzDevOpsProject -ApiUri $ApiUri -Pat $Pat -ProjectId '114bff8d-6169-45cf-b085-fe121267e7aa' # Non-present "ProjectId"
                        $result | Should -BeFalse
                    }
                }

                Context 'When a "Project" with supplied "ProjectId" parameter value does exist' {

                    It 'Should return $true - "<ApiUri>", "<Pat>"' -TestCases $testCasesValidApiUriPatCombined {
                        param ([string]$ApiUri, [string]$Pat)

                        $result = Test-AzDevOpsProject -ApiUri $ApiUri -Pat $Pat -ProjectId $($mockProjectIds[0].ProjectId)
            ...
            Context 'When called with invalid "Pat" parameter' {
                ...
                Context 'When called without "ApiUri" parameter' {
                    It "Should throw - '<Pat>'" -TestCases $testCasesInvalidPats {
                        ...
                        { Test-AzDevOpsProject -Pat $Pat } | Should -Throw
                ...
                Context 'When called with valid "ApiUri" parameter' {
                    It "Should throw - '<Pat>'" -TestCases $testCasesInvalidPats {
                        ...
                        { Test-AzDevOpsProject -ApiUri $validApiUri -Pat $Pat } | Should -Throw
                ...
                Context 'When called with invalid "ApiUri" parameter' {
                    It "Should throw - '<Pat>'" -TestCases $testCasesInvalidPats {
                        ...
                        { Test-AzDevOpsProject -ApiUri $invalidApiUri -Pat $Pat } | Should -Throw
            ...
            Context 'When called with invalid "ApiUri" parameter' {
                ...
                Context 'When called without "Pat" parameter' {
                    It "Should throw - '<ApiUri>'" -TestCases $testCasesInvalidApiUris {
                        ...
                        { Test-AzDevOpsProject -ApiUri $ApiUri } | Should -Throw
                ...
                Context 'When called with valid "Pat" parameter' {
                    It "Should throw - '<ApiUri>'" -TestCases $testCasesInvalidApiUris {
                        ...
                        { Test-AzDevOpsProject -ApiUri $ApiUri -Pat $validPat } | Should -Throw
                ...
                Context 'When called with invalid "Pat" parameter' {
                    It "Should throw - '<ApiUri>'" -TestCases $testCasesInvalidApiUris {
                        ...
                        { Test-AzDevOpsProject -ApiUri $ApiUri -Pat $invalidPat } | Should -Throw
